...
// src/pages/HomeScreen.tsx - PINTEREST-STYLE REDESIGN
...
export default function HomeScreen({
  ...
  const fetchOffers = useCallback(async (silent = false, force = false) => {
    ...
    try {
      ...
      const processedOffers = data.map((offer: Offer) => {
        // Get image - use random book covers for offers without images
        ...
        if (offer.imageUrl?.startsWith('data:image')) {
          ...
          // Random book cover from Unsplash based on genre/type
          const bookCovers = [
            "https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=400&h=600&fit=crop", // Classic
            "https://images.unsplash.com/photo-1541963463532-d68292c34b19?w=400&h=600&fit=crop", // Literature
            "https://images.unsplash.com/photo-1512820790803-83ca734da794?w=400&h=600&fit=crop", // Fantasy
            "https://images.unsplash.com/photo-1532012197267-da84d127e765?w=400&h=600&fit=crop", // Mystery
            "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=600&fit=crop", // Romance
            "https://images.unsplash.com/photo-1551029506-0807df4e2031?w=400&h=600&fit=crop", // Sci-Fi
            "https://images.unsplash.com/photo-1516979187457-637abb4f9353?w=400&h=600&fit=crop", // Biography
            "https://images.unsplash.com/photo-1543002588-bfa74002ed7e?w=400&h=600&fit=crop", // History
          ];
  ...
  const getImageSource = useCallback((offer: Offer): string => {
    return offer.imageUrl || "https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=400&h=600&fit=crop";
  }, []);
  ...
  const PinterestCard = useMemo(() => 
    React.memo(({ offer }: { offer: Offer }) => {
      ...
      return (
        ...
        >
          {/* Book Image */}
          <div style={{ position: "relative", paddingTop: "150%" }}> // 2:3 aspect ratio
            <img
              src={imageSrc}
              alt={offer.bookTitle}
              style={{
            ...
            {/* Non-hover overlay (minimal info) */}
            {!isHovered && (
              <div style={{
                position: "absolute",
                bottom: 0,
  ...
  const filterOptions = [
    ...
    { id: "sell" as const, label: "For Sale" },
    { id: "exchange" as const, label: "Exchange" },
    { id: "buy" as const, label: "Wanted" },
  ];
      ...
      <div style={{ 
        ...
        <main
          style={{
            ...
            gridAutoRows: "0", // Let rows size based on content
            gap: "16px",
            alignContent: "start",
          }}
        >
          {loading ? (
            ...
            <div style={{ 
              ...
              <h3 style={{ color: PINTEREST.textDark, marginBottom: "8px", fontSize: "18px" }}>
                Unable to load books
              </h3>
              <p style={{ color: PINTEREST.textLight, marginBottom: "24px", fontSize: "14px" }}>
                {error}
              </p>
              <motion.button
                whileHover={{ scale: 1.05 }}
